import { InjectionToken, Inject, Injectable, Optional, NgModule, Pipe, defineInjectable, inject, EventEmitter, Directive, ElementRef, Renderer2, ChangeDetectorRef, Input, Output, HostListener } from '@angular/core';
 ...
 */
/** @type {?} */
var CONFIG = new InjectionToken('SHARE_BUTTONS_CONFIG');
...
var ShareDirective = /** @class */ (function () {
    ...
    function () {
        ...
        if (this.platform.isBrowser) {
            ...
            (_a = of({
                ...
                metaTags: metaTags
            })).pipe.apply(_a, __spread(this.prop.share.operators, [tap(function (sharerURL) { return _this.share(sharerURL); }),
                take(1)])).subscribe();
        }
    };
    /**
    ...
    function (shareUrl) {
        ...
        return options.request === 'jsonp'
            ? 
            // @ts-ignore
            (_a = this.http.jsonp(options.url + shareUrl, 'callback')).pipe.apply(_a, __spread(options.operators, [catchError(function () { return EMPTY; })])) : 
        // @ts-ignore
        (_b = this.http.get(options.url + shareUrl, options.args)).pipe.apply(_b, __spread(options.operators, [catchError(function () { return EMPTY; })]));
    };
    /**
     * @param {?} buttonsName
     * @return {?}
